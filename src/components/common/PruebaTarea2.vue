    ...
    nuevoObjetoTarea:
{
  ...
  ,props: {
        ...
        // Obtener la hora actual
          ...
          const horaFormateada = horaActual.toISOString(); // Formatear la hora como una cadena ISO

        this.nuevoObjetoTarea.fechahoratarea = horaFormateada;
        ...
        this.nuevoObjetoTarea.estadoIdestado.idestado=3;
